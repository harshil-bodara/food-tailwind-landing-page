...
export default function Sidebar() {
    ...
    return (
        <div className="h-[calc(100vh - 100px)]">
            ...
            <aside id="default-sidebar" className={`absolute xl:pt-10 lg:pt-0 xl:block -z-40 h-[calc(100vh-100px)] transition-transform overflow-y-hidden dark:bg-gray-800 w-[400px] ${open ? 'flex left-0' : '-left-[400px] lg:left-0'}`}>

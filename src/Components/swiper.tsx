...
export default function Swiper1() {
    return (
        <div className="lg:px-20 min-[320px]:px-2 lg:pt-8">
            <>
                <Swiper
                    slidesPerView={5}
                    spaceBetween={1}
                        ...
                        <SwiperSlide>
                            <div className="flex lg:h-[320px] sm:h-[302px] min-[320px]:h-[302px] rounded-2xl bg-[#F8F7F5] lg:pe-6">
                                <div className="relative w-100%">
                                    <Image src={swiper.img} alt="" className="lg:h-[100px] lg:w-[168px] sm:w-[152px] sm:h-[70px] min-[320px]:w-[152px] h-[75px] mt-2 mx-auto"></Image>
                                    ...
                                    <div className="flex justify-center lg:mt-3 ms-2">

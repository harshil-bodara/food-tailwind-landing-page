        ...
        <div className="xl:px-20 min-[320px]:pt-4 sm:pt-2 xl:pt-[60px] sm:px-4 md:px-2 lg:px-20 lg:pt-10 md:pt-6">
            <div className="flex lg:flex-row sm:flex-col min-[320px]:flex-col min-[320px]:pt-[17px] md:pt-0 md:px-2">
                <Swiper navigation={true} pagination={true} modules={[Navigation, Pagination]} loop={true} className="myswiper lg:w-4/5 min-[320px]:w-full">
                    {swipers.map((swiper) =>
                        <SwiperSlide>
                            <Image src={main} alt="" className="min-[320px]:pt-10 lg:w-full md:px-0 min-[320px]:px-2 lg:pe-3 lg:4/5 sm:w-full rounded-2xl sm:px-4 lg:px-0 lg:pt-0 lg:mt-0 text-[#555555] min-[320px]:w-full"></Image>
                        </SwiperSlide>
                    )}
                </Swiper>
                <div className="flex lg:flex-col sm:flex-row sm:px-4 lg:px-0 lg:w-2/5 min-[320px]:flex-row min-[320px]:pt-[10px] lg:pt-0 px-2 md:px-2">
                    <Image src={main1} alt="" className="sm:pt-3 lg:w-full sm:2/5 min-[320px]:w-3/5 min-[320px]:pt-2 md:w-3/5 min-[320px]:pe-2.5 lg:pt-0"></Image>
                    ...
                    <Image src={main2} alt="" className="lg:w-full sm:w-2/5 lg:ps-5 sm:pt-3 lg:hidden sm:block min-[320px]:w-2/5 pt-2 md:hidden"></Image>
                </div>
            </div>
        </div>
    );
